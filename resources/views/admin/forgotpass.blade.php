        ...
        <div class="col-4">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <form method="POST" action="{{ url('resetpassword') }}" id="change-email-form">
              @csrf
                <div class="row">
                <div class="col-md-12">
                  ...
                  <div class="col-md-12 form-controls my-3 text-right">
                    <button type="submit" class="btn btn-primary btn-block"><i class="far fa-user"></i> Reset Password</button>
                  </div>
                </div>
              </form>
            </div>
