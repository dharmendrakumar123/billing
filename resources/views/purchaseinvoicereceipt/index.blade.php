	  ...
	  <div class="container-fluid">
		<div class="row d-flex justify-content-end align-items-center">
		  ...
		  <div class="col-8 text-right">
			<a href="{{url('/purchase-receipt/create')}}" class="btn btn-primary mr-2">Add</a>
            ...
            <div class="card" style="margin-top: 3%;border-radius: 10px;font-size: 13px;">
              <!--<div class="card-header">
                <div class="row">
                  ...
                  <div class="col text-right"><a href="{{url('/purchase-receipt/create')}}" class="btn btn-primary mr-3"><i class="icon icon-plus"></i>
                      Add New</a></div>
                </div>
              </div>-->
                     ...
                     @if(count($salereceipt)>0)
                      @foreach($salereceipt as $receipt)
                        <tr>
                          ...
                          <td>
                            <a href="{{url('/purchase-receipt/'.$receipt->id.'/edit')}}" class="btn btn-warning">Edit</a>
                          </td>
