                      ...
                      <tbody class="ui-sortable product-list-row">
                        <tr class="product-item-row">
                          ...
                          <td>
                            ...
                            <select name="product_id[]"  class="product_id form-control product-item select2" style="width:200px;">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-4">
                          <div class="form-group">
                            ...
                            <div class="controls ">
                              <input name="document_note"  class="form-control">
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="col-md-4">
                          <div class="form-group">
                            ...
                            <div class="controls ">
                              <!-- <input name="payment_type"  class="form-control"> -->
                        ...
                        <div class="col-md-8">
                          <div class="form-group">
                            ...
                            <div class="controls ">
                              <input name="payment_note"  class="form-control">
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="col-md-6">
                          <div class="form-group">
                            ...
                            <div class="controls ">
                              <textarea name="bank_term_condition" 
                        ...
                        <div class="col-md-6 d-flex align-items-end justify-content-end">
                          <a href="{{url('/purchase-invoice')}}" class="btn btn-light  mr-2"><i class="fa fa-chevron-left"></i>Back</a>
                          <button type="submit"  name="" class="btn btn-primary mr-2"><i class="fa fa-save"></i> Save</button>
                          <button  name="" value="" class="btn btn-primary"><i class="fa fa-print"></i>Save & Print</button>
                        </div>
                      </div>
                    </div>
