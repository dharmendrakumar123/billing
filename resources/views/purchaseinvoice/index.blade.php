  ...
  <div class="container-fluid">
    <div class="row d-flex justify-content-end align-items-center">
      ...
      <div class="col-8 text-right">
        <a href="{{ url('/purchase-invoice/create')}}" class="btn btn-primary mr-2">Add</a>
        ...
        <table class="table table-border table-hover" data-footable="" id="purchase-invoice-datatable"
          ...
          <tbody>
            ...
            <tr class="table-bill-detail-rows">
              ...
              <td><a href="{{url('/purchase-invoice/'.$invoice->id.'/edit')}}" class="btn btn-outline-primary"><i
                    class="icon icon-pencil"></i>Edit</a></td>
              <td>
                <p><a href="{{url('print-invoice-purchase')}}?id={{$invoice->id}}" class="btn btn-info print-btn"
